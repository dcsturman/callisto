...
use crate::entity::{Entity, Entities, G};
use crate::payloads::{AddPlanetMsg, AddShipMsg, ComputePathMsg, FireActionsMsg, FlightPathMsg, RemoveEntityMsg, SetPlanMsg};
use crate::computer::{compute_flight_path, FlightParams};
// Struct wrapping an Entities list
...
impl Server {
    ...
    pub fn update(&self, fire_actions: FireActionsMsg, rng: &mut dyn RngCore) -> Result<String, String> {
